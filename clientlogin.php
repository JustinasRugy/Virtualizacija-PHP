...
<head>
    ...
    <title>Paciento prisijungimas</title>
    ...
    <style>
        * { -webkit-box-sizing:border-box; -moz-box-sizing:border-box; -ms-box-sizing:border-box; -o-box-sizing:border-box; box-sizing:border-box; }
        ...
        input {
            ...
            border-radius: 4px;
            box-shadow: inset 0 -5px 45px rgb(242, 170, 255), 0 1px 1px rgba(255,255,255,0.2);
...
and password='".md5($password)."' AND gydytojas_pacientas ='0'";
    ...
    if($rows==1){
        ...
        echo "<div class='form'>
<h3><center>Jūs arba gydytojas arba nesate prisiregistarvęs. Jeigu nesate gydytojas prašome užsiregistruoti</center></h3>
<br/><center>Spauskite čia, kad galėtumėte prisiregistruoti <a href='registrationpagepacient.php'>Registruotis</a></center></div>";
    }
}else{
    ?>
    <div class="login">
        <h1>Paciento prisijungimas</h1>
        <form method="post">
            ...
            <p>Dar neprisiregistravote? <a href='registrationpagepacient.php'>Registruokites čia!</a></p>
        </form>
    </div>
<?php } ?>
</body>
